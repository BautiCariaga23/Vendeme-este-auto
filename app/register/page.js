  ...
  return (
    <div className='grid place-items-center min-h-screen h-full bg-white'>
      <NavBar></NavBar>
        ...
        <button onClick={()=>{valid ? push(`/api/register?user=${email}&pass=${pass}&name=${name}`) : alert("Revisa las credenciales!")}} className='bg-black text-white p-2 rounded-lg'>Register</button>
