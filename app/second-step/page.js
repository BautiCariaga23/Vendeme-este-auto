...
export default function page() {
  ...
  return (
    ...
    <main className='w-full py-4 sm:ml-36'>
        ...
        <Link href ={`/api/upload?title=${data.get("title")}&model=${data.get("model")}&price=${data.get("price")}&img=${data.get("img")}&desc=${data.get("desc")}&usr=${data.get("usr")}&ver=${data.get("ver")}&lvl=1&year=${data.get("year")}&km=${data.get("km")}&city=${data.get("city")}`}><div className='grid hover:cursor-pointer hover:scale-105 duration-150 text-amber-700 bg-white rounded-lg p-8 w-80 h-96 place-items-center gap-y-4'>
        ...
        <Link href ={`/api/upload?title=${data.get("title")}&model=${data.get("model")}&price=${data.get("price")}&img=${data.get("img")}&desc=${data.get("desc")}&usr=${data.get("usr")}&ver=${data.get("ver")}&lvl=2&year=${data.get("year")}&km=${data.get("km")}&city=${data.get("city")}`}><div className='grid hover:cursor-pointer hover:scale-105 duration-150 text-gray-500 bg-white rounded-lg p-8 w-80 h-96 place-items-center gap-y-4'>
        <svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 24 24"><path fill="currentColor" d="M20 2H4v2l5.81 4.36a7.004 7.004 0 0 0-4.46 8.84a6.996 6.996 0 0 0 8.84 4.46a7 7 0 0 0 0-13.3L20 4zm-5.06 17.5L12 17.78L9.06 19.5l.78-3.33l-2.59-2.24l3.41-.29L12 10.5l1.34 3.14l3.41.29l-2.59 2.24z"/></svg>
        ...
        <Link href ={`/api/upload?title=${data.get("title")}&model=${data.get("model")}&price=${data.get("price")}&img=${data.get("img")}&desc=${data.get("desc")}&usr=${data.get("usr")}&ver=${data.get("ver")}&lvl=3&year=${data.get("year")}&km=${data.get("km")}&city=${data.get("city")}`}> <div className='grid hover:cursor-pointer hover:scale-105 duration-150 text-yellow-500 bg-white rounded-lg p-8 w-80 h-96 place-items-center gap-y-4'>
        <svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 24 24"><path fill="currentColor" d="M20 2H4v2l5.81 4.36a7.004 7.004 0 0 0-4.46 8.84a6.996 6.996 0 0 0 8.84 4.46a7 7 0 0 0 0-13.3L20 4zm-5.06 17.5L12 17.78L9.06 19.5l.78-3.33l-2.59-2.24l3.41-.29L12 10.5l1.34 3.14l3.41.29l-2.59 2.24z"/></svg>
